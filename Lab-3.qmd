...
1.  Solve for the numerator of `a`
2.  $n\sum XY -\sum X\sum Y$
...
2.  Solve for the denominator of `b`
3.  $b = \frac{243.25}{n\sum X^2-\sum (X)^2}$
...
1.  Solve for `a`
2.  $a = \mathrel{\bar{Y}}-b\mathrel{\bar{X}}$
