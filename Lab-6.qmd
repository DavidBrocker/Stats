...
1.  First, we can find the SEM.

$$\sigma_x = \frac{2.4}{\sqrt{13}} = .66$$

1.  Then we will need to find the mean:

2.  $Xbar = \frac{71+74+73+71+78+73+72+71+73+72+74+72+75}{13} = 73$

3.  We can then plug that into the Z formula:

4.  $Z_{obt} = \frac{73-71}{.66} = 3.0$

5.  Then we can look in the Z-Table(link) for the $Z_{crit}$ of .05 is 1.64.
